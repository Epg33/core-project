      ...
      <div className='flex flex-col items-center gap-5 h-full w-full'>
        ...
        <div className='flex flex-col w-full gap-2'>
          ...
          <div className="w-full h-fit flex gap-2">
            <button onClick={()=>vote(true)} className='text-center rounded-md w-2/4 h-14 bg-cyan-600 text-xl transition-all duration-300 ease-in hover:bg-cyan-500'>Vote Yes</button>
            <button onClick={()=>vote(false)} className='text-center rounded-md w-2/4 h-14 bg-red-600 text-xl transition-all duration-300 ease-in hover:bg-red-500'>Vote No</button>
          </div>
        </div> 
      </div>
    </section>
